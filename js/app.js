...
var sheetCnMap = {
    ...
    "Housewares":"家具","Miscellaneous":"杂项","Music":"音乐","Other":"3.0DLC","Photos":"照片",
...
var ACNHCDN = "https://cdn.jsdelivr.net/gh/leezzznn/acnh-items@44fc620/img/";
var LOCAL_IMG = "https://cdn.jsdelivr.net/gh/leezzznn/acnh-items@44fc620/img/";
var VILLAGER_IMG_DIR = "https://cdn.jsdelivr.net/gh/leezzznn/acnh-items@44fc620/img/";
...
,
    ...
    "Cool set": "酷感系列"
,
    "Variant Remake_0_0": "款式 1",
    "Variant Remake_0_1": "款式 1",
    "Variant Remake_0_2": "款式 1",
    "Variant Remake_0_3": "款式 1",
    "Variant Remake_0_4": "款式 1",
    "Variant Remake_0_5": "款式 1",
    "Variant Remake_0_6": "款式 1",
    "Variant Remake_0_7": "款式 1",
    "Variant Remake_1_0": "款式 2",
    "Variant Remake_1_1": "款式 2",
    "Variant Remake_1_2": "款式 2",
    "Variant Remake_1_3": "款式 2",
    "Variant Remake_1_4": "款式 2",
    "Variant Remake_1_5": "款式 2",
    "Variant Remake_1_6": "款式 2",
    "Variant Remake_1_7": "款式 2",
    "Variant Remake_2_0": "款式 3",
    "Variant Remake_2_1": "款式 3",
    "Variant Remake_2_2": "款式 3",
    "Variant Remake_2_3": "款式 3",
    "Variant Remake_2_4": "款式 3",
    "Variant Remake_2_5": "款式 3",
    "Variant Remake_2_6": "款式 3",
    "Variant Remake_2_7": "款式 3",
    "Variant Remake_3_0": "款式 4",
    "Variant Remake_3_1": "款式 4",
    "Variant Remake_3_2": "款式 4",
    "Variant Remake_3_3": "款式 4",
    "Variant Remake_3_4": "款式 4",
    "Variant Remake_3_5": "款式 4",
    "Variant Remake_3_6": "款式 4",
    "Variant Remake_3_7": "款式 4",
    "Variant Remake_4_0": "款式 5",
    "Variant Remake_4_1": "款式 5",
    "Variant Remake_4_2": "款式 5",
    "Variant Remake_4_3": "款式 5",
    "Variant Remake_4_4": "款式 5",
    "Variant Remake_4_5": "款式 5",
    "Variant Remake_4_6": "款式 5",
    "Variant Remake_4_7": "款式 5",
    "Variant Remake_5_0": "款式 6",
    "Variant Remake_5_1": "款式 6",
    "Variant Remake_5_2": "款式 6",
    "Variant Remake_5_3": "款式 6",
    "Variant Remake_5_4": "款式 6",
    "Variant Remake_5_5": "款式 6",
    "Variant Remake_5_6": "款式 6",
    "Variant Remake_5_7": "款式 6",
    "Variant Remake_6_0": "款式 7",
    "Variant Remake_6_1": "款式 7",
    "Variant Remake_6_2": "款式 7",
    "Variant Remake_6_3": "款式 7",
    "Variant Remake_6_4": "款式 7",
    "Variant Remake_6_5": "款式 7",
    "Variant Remake_6_6": "款式 7",
    "Variant Remake_6_7": "款式 7",
    "Variant Remake_7_0": "款式 8",
    "Variant Remake_7_1": "款式 8",
    "Variant Remake_7_2": "款式 8",
    "Variant Remake_7_3": "款式 8",
    "Variant Remake_7_4": "款式 8",
    "Variant Remake_7_5": "款式 8",
    "Variant Remake_7_6": "款式 8",
    "Variant Remake_7_7": "款式 8"
};
...
function isInRecipeList(itemId) { var firstId = String(itemId || "").split(",")[0]; return RECIPE_MAP.hasOwnProperty(firstId); }
function getRecipeHex(itemId) { var firstId = String(itemId || "").split(",")[0]; return RECIPE_MAP[firstId] || null; }
function getItemImageURL(itemId, suffix) {
    ...
    if (item && item.variants && item.variants.length > 0) {
        ...
        if (variantIndex >= 0 && variantIndex < item.variants.length) {
            ...
            if (variantFilename) {
                var fixedFn = variantFilename.replace(/([^_])Remake/,"$1_Remake"); return LOCAL_IMG + fixedFn + ".png";
            }
        }
        // 回退到 base filename
        if (item.filename) {
...
function getItemVariantValue(item, suffix) {
    var idx = parseInt(suffix) || 0;
    if (!item.variants || idx < 0 || idx >= item.variants.length) return idx;
    var name = item.variants[idx].variation || item.variants[idx].filename || "";
    var m = name.match(/Remake[_-](\d+)[_-](\d+)/i);
    if (m) {
        var x = parseInt(m[1], 10);
        var y = parseInt(m[2], 10);
        return x * 16 + y;
    }
    var m2 = name.match(/Variant[_-]?(\d+)/i);
    if (m2) return parseInt(m2[1], 10);
    return idx;
}
function getItemOrderHex(item, suffix) {
    var hexes = String(item.hex || "").split(",").map(function(x){ return cleanHex(x.trim()); });
    var idx = parseInt(suffix) || 0;
    if (hexes.length > 1 && idx >= 0 && idx < hexes.length) return hexes[idx];
    var h = hexes[0] || "";
    var variantValue = getItemVariantValue(item, suffix);
    if (variantValue === 0) return h;
    return variantValue.toString(16).toUpperCase() + "0000" + h.padStart(4,"0");
}
...
function openBackpackModal() {
    document.getElementById("backpackModal").classList.add("active");
    document.body.style.overflow = "hidden";
    updateBackpack();
}
function closeBackpackModal() {
    document.getElementById("backpackModal").classList.remove("active");
    document.body.style.overflow = "";
}
function clearBackpack() {
    if (backpack.length === 0 && !selectedVillager) { showToast(lang==="zhs"?"背包已经空了":"背包已經空了"); closeBackpackModal(); return; }
    backpack = [];
...
function copyCommand() {
    ...
    backpack.forEach(function(entry){
        ...
        if (type === "diy") {
            ...
            parts.push(getItemOrderHex(item, suffix));
        }
    });
...
function initDraggable(el) {
    ...
    el.addEventListener("mousedown",function(e){
        if (e.target.closest(".remove-villager")) return;
        dragging=true;
...
document.getElementById("orderBtn").addEventListener("click", function() {
    ...
    var r = document.getElementById("orderResult");
    btn.textContent = "⏳"; btn.disabled = true; r.style.display = "none";
    var items = [];
    ...
    .then(function() {
        ...
        r.style.cssText = "display:block;margin-top:6px;padding:8px;background:#e8f5e9;border:1px solid #c8e6c9;border-radius:4px;text-align:center;font-size:13px;";
        r.innerHTML = '<div style="font-size:11px;color:#666;margin-bottom:4px;">长按复制: <b>' + fullCmd + '</b></div>';
        // 复制到剪贴板（兼容电脑和手机）
        var copyText = fullCmd;
        var done = false;
        if (navigator.clipboard && navigator.clipboard.writeText) {
            navigator.clipboard.writeText(copyText).then(function(){ done = true; }).catch(function(){});
        }
        setTimeout(function() {
            if (!done) {
                var ta = document.createElement("textarea");
                ta.value = copyText;
                ta.style.cssText = "position:fixed;left:0;top:0;width:100px;height:30px;opacity:0";
                document.body.appendChild(ta);
                ta.focus(); ta.select();
                try { document.execCommand("copy"); } catch(e2) {
                    r.innerHTML = '<div style="font-size:11px;color:#666;margin-bottom:4px;">请选择以下文本手动复制:</div>' +
                        '<textarea readonly style="width:100%;padding:6px;font-size:12px;border:1px solid #ccc;border-radius:4px;box-sizing:border-box;height:36px;" onclick="this.select()">' + copyText + '</textarea>';
                }
...
// ===== BACKPACK EVENT LISTENERS =====
document.getElementById("backpackFab").addEventListener("click", openBackpackModal);
document.getElementById("closeBackpackModal").addEventListener("click", closeBackpackModal);
